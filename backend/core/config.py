...
class AuraConfig:
    def __init__(self, config_path: Optional[Path] = None):
        ...
        # Validate config file path to prevent traversal
        validated = SecurityValidator.validate_file_path(
            str(self.config_path),
            allowed_dirs=[str(self.config_path.parent)]
        )
        self.config_path = Path(validated)
